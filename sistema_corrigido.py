...
<div id="home" class="tc active">
    ...
    <div class="kg">
        ...
        <div class="kc gr"><div class="l">&#127959;&#65039; Mat. Constru&#231;&#227;o</div><div class="v">+28% Vendas</div></div>
...
<div id="erp" class="tc">
    <div class="cd"><h3>&#128279; Configura&#231;&#227;o de Integra&#231;&#227;o ERP</h3>
        ...
        <form onsubmit="saveERP(event)"><input type="hidden" id="erpId">
            ...
            <h4 style="margin:15px 0;color:#374151;">&#128452;&#65039; Banco de Dados Local</h4>
            <div class="fr">
            ...
            <div class="fr">
                ...
                <div class="fg">
                    ...
                    <select id="eseg">
                        ...
                        <option value="construcao">&#127959;&#65039; Material de Constru&#231;&#227;o</option>
...
function showTab(tab) {
    ...
    var titles = {
        ...
        construcao: '&#127959;&#65039; Material de Constru&#231;&#227;o',
    ...
    if (d.items && d.items.length > 0) {
        document.getElementById('etable').innerHTML = d.items.map(function(i) {
            ...
            return '<tr>' +
                ...
                '<td>' + (rupture ? '<span class="badge badge-d">&#9888;&#65039; Sim</span>' : '<span class="badge badge-s">&#9989; N&#227;o</span>') + '</td>' +
...
async function loadCompanies() {
    ...
    document.getElementById('compTable').innerHTML = d.map(function(c) {
        return '<tr>' +
            ...
            '<td><span class="badge ' + (c.environment == 'producao' ? 'badge-p' : 'badge-i') + '">' + (c.environment == 'producao' ? '&#128640; Produ&#231;&#227;o' : '&#127959;&#65039; Homologa&#231;&#227;o') + '</span></td>' +
            '<td><span class="badge ' + (c.active ? 'badge-s' : 'badge-d') + '">' + (c.active ? 'Ativa' : 'Inativa') + '</span></td>' +
            '<td>' +
                '<button class="btn btn-sm btn-p" onclick="editComp(' + c.id + ')">&#9999;&#65039; Editar</button> ' +
                '<button class="btn btn-sm btn-d" onclick="delComp(' + c.id + ')">&#128465;&#65039; Excluir</button>' +
            '</td>' +
            '</tr>';
    }).join('');
}
...
async function loadUsers() {
    ...
    document.getElementById('userTable').innerHTML = d.map(function(u) {
        return '<tr>' +
            ...
            '<td>' +
                '<button class="btn btn-sm btn-p" onclick="editUser(' + u.id + ')">&#9999;&#65039; Editar</button> ' +
                '<button class="btn btn-sm btn-d" onclick="delUser(' + u.id + ')">&#128465;&#65039; Excluir</button>' +
            '</td>' +
            '</tr>';
    }).join('');
...
async function loadLicenses() {
    ...
    document.getElementById('licTable').innerHTML = d.map(function(l) {
        return '<tr>' +
            ...
            '<td>' +
                '<button class="btn btn-sm btn-p" onclick="editLic(' + l.id + ')">&#9999;&#65039;</button> ' +
                '<button class="btn btn-sm btn-w" onclick="blockLic(' + l.id + ')">&#128683; Bloquear</button> ' +
                '<button class="btn btn-sm btn-d" onclick="delLic(' + l.id + ')">&#128465;&#65039;</button>' +
            '</td>' +
            '</tr>';
    }).join('');
...
def api_test_erp(cid):
    ...
    return jsonify({'success': True, 'message': '&#9888;&#65039; Configure API ou Banco de dados'})
...
if __name__ == '__main__':
    ...
    print("   7. &#127959;&#65039; Material de Constru&#231;&#227;o")
